...
<div class="text-black">
	<div class="flex flex-row -mt-5 w-[80%] lg:w-[40%] text-white text-center justify-center mx-auto space-x-3">
		<button
			on:click|preventDefault={() => {
	...
	{#each currentDealList as deal}
		<div
			class="bg-gray-700 text-white rounded-xl w-[85%] max-w-screen-lg flex flex-col sm:flex-row shadow-md p-5 mx-auto my-5
			sm:space-x-5"
		>
			
			<!--Image-->
			<div class="bg-gray-200 w-full max-w-screen-xs mx-auto rounded-lg overflow-hidden">
			...
			<div class="px-1 py-5 flex flex-col justify-between sm:py-0">
			<!--Category + Description + Other-->
			<div class=" w-full flex flex-row">
				<div class="w-full">
					<div class="flex justify-between items-center">
						<h1 class="font-bold text-2xl uppercase">{deal.title}</h1>
						<div class="text-xs text-gray-400 ">
							Published: {deal.publishDate.toISOString().slice(0, 10)}
						</div>
					</div>
					<div class="flex text-xs justify-start space-x-1 mt-2 mb-4">
