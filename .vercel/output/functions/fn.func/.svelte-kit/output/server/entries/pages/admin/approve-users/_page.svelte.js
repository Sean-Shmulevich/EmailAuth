import { c as create_ssr_component, o as each, i as escape, b as add_attribute } from "../../../../chunks/index2.js";
/* empty css                      */import "devalue";
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div class="bg-white rounded-xl mx-auto mt-10 max-w-[90%] px-10 pb-10 w-[85%] mb-12"><h1 class="text-center pt-10 text-6xl">Admin approve users</h1>
	...
	<div class="mt-10"><div class="mx-auto mb-10 text-center rounded-3xl py-4 w-[20%] bg-black text-white"><a class="text-center" href="/admin/approve-brands">go to approve brands</a></div>
		<div class="mx-auto mb-10 text-center rounded-3xl py-4 w-[20%] bg-black text-white"><a class="text-center" href="/admin/deal-contracts">View deal contracts</a></div>
