...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<a title="Create a new Deal" class="absolute transform scale-75 sm:scale-100 -right-4 top-4 sm:top-5 sm:-right-5 p-5" href="/creation-center/brand-create-offer"><img class="w-14 mr-0 transform translate-x-[10px]" alt="create deal" src="https://slimecars.com/assets/createDeal.png">
...
<div class="text-black"><div class="flex flex-row -mt-5 w-[80%] lg:w-[40%] text-white text-center justify-center mx-auto"><button class="${"w-1/3 p-3 rounded-xl " + escape(
