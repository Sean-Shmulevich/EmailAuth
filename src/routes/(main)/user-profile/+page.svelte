...
>
	...
	>
		<div class="image w-full md:w-1/2 relative">
			...
			<div class="absolute bottom-3 flex justify-center w-full space-x-8" style="transform: translateX(-6px)">
		...
		<div class="profile-text mt-5 md:mt-0 md:pl-6 w-full md:w-1/2 flex flex-col" style="height:inherit">
            ...
            <div class="flex flex-row items-center justify-between mt-5 bottom-0 info-container">
                <div class="flex items-center text-sm leading-5 text-gray-400 info-item">
                    <svg
                        class="flex-shrink-0 mr-1.5 text-gray-500"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                    >
                        <path
