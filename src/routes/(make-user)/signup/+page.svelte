...
{#if showTOS}
	...
	>
		...
		<br /><br />
		<p class="text-xl">Terms of use</p>

		<br /><br />
		<p class="text-lg font-extrabold">1. INTRODUCTION</p>
		<br />
		<p>
			DapUp, LLC (“DapUp”) is a digital influence agency that connects Athletes (as defined below)
		...
		<p class="text-lg font-extrabold">2. ACCEPTANCE OF THIS AGREEMENT</p>
		<br />
		You can accept this Agreement by:
		<ol>
			<li>1. Viewing on the “I Agree” or “I Accept” box;</li>
			<li>
				2. Registering in the DapUp’s online platform (“Platform”) at https://www.dapup.co ; or
			</li>
			<li>
				3. Accessing or using the Platform or otherwise accepting to participate in a campaign by
				Businesses (“Campaign”).
			</li>
		</ol>
		<br />
		<p>
			The term of this Agreement will commence on the date any of the earliest above numbered events
			...
			should print oﬀ or save a local copy of the Terms of Use for Your records.
		</p>
		<br /><br />

		<p class="text-lg font-extrabold">3. CAMPAIGNS</p>
		<br />
		<p>
			DapUp’s method of operations: Participating Businesses create and send Campaigns through the
			...
			participate in any future DapUp Campaigns and/or being removed from the DapUp Platform.
		</p>
		<br />
		<p class="text-lg font-extrabold">4. REVIEWS &amp; APPROVALS</p>
		<br />
		<p>
			DapUp in its sole discretion shall determine whether Athlete has complied with the
		...
		<br />
		<p>
			In order to access the Platform and provide Services, You may be required to provide
		...
		<br />
		<p>
			Your account, account ID and password is for Your sole use. You may not distribute, transfer
		...
		<br />
		<p>
			For information about DapUp’s data protection practices, please read DapUp’s Privacy Policy.
		...
		<br />
		<p>
			You must be eighteen (18) years or older to register as an Athlete in the Platform. If you are
		...
		<br />
		<p>
			Businesses will pay Athlete pursuant to the formal contract between Athlete and Business.
		...
		<br />
		<p>
			Athlete should be aware that Content presented to them as part of the Campaign, including but
		...
		<br />
		<p>
			Every Athlete registering to DapUp, and any Athlete utilizing the Platform for participation
		...
		<br />
		<p>
			“Confidential Information” means any information disclosed to an Athlete by DapUp, either
		...
		<br />
		<p>
			All participants in the Platform or a Campaign shall comply with the following Requirements
		...
		<br />
		<p>
			DapUp reserves the right, at any time, to modify, update or revise this Agreement, without
		...
		<br />
		<p>
			Athletes participating in the Platform each represent, warrant and covenant to DapUp and
		...
		<br />
		<p>
			You acknowledge and agree that DapUp (or DapUp´s licensors) own all legal rights, title and
			...
			applicable laws. To make a claim, please provide us with the following:<br /><br />
			1. A description of the copyrighted work that You claim has been infringed;<br />

			2. Information suﬃcient to enable DapUp to locate the allegedly infringing Content on the
			Service;<br />

			3. Your address, telephone number and email address;<br />
			...
			are the copyright owner or authorized to act on the copyright owner&#39;s behalf; and<br />
			6. A signature of the person authorized to act on behalf of the owner of the copyright interest.<br
			/>
		...
		<br />
		<p>
			Athletes participating in the Platform (“Indemnitors”) each agree to indemnify and hold
		...
		<br />
		<p>
			ATHLETE EXPRESSLY AGREES THAT THE SERVICES ARE AVAILABLE ON AN “AS IS“ BASIS, WITHOUT WARRANTY
		...
		<br />
		<p>
			DAPUP SHALL NOT BE LIABLE TO ATHLETE FOR DAMAGES OF ANY KIND ARISING OUT OF ATHLETE’S USE OF
		...
		<br />
		<p>
			Except for copyright infringement notices as set forth in Section [17]: Copyright, Trademarks,
		...
		<p>
			...
			in electronic form. Please print and save a copy of this Agreement for Your records.
		</p>
		<p class="text-lg font-extrabold">25. TERMINATION</p>
		<br />
		<p>
		...
		<br />
		<p>
			DapUp will have the right to assign this Agreement and rights and delegate its duties in
		...
		<br />
		<p>
			User understands and agrees that this Agreement and any notices given pursuant to this
